...
export class SovereignBridge {
  ...
  private static getAuthToken(): string {
    ...
    return process.env.SOVEREIGN_AUTH_TOKEN || 'SOVEREIGN_DEV_TOKEN';
  }

  private static makeContext(context?: BridgeCallContext): Required<BridgeCallContext> {
  ...
  private static async getMetadata(context?: BridgeCallContext): Promise<any> {
    ...
    const resolved = this.makeContext(context);
